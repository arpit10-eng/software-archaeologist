    ...
    if complexity.get("complexity_level") in {"High", "Very High"}:
        recommendations.append(
            _recommendation(
                ...
                "Several functions contain high branching complexity.",
                "High",
                "Maintainability",
                [
                    f"Complexity level: {complexity.get('complexity_level')}",
                    f"Average complexity: {complexity.get('average_cyclomatic_complexity', 0)}",
                ],
    ...
    if largest > 300:
        recommendations.append(
            _recommendation(
                ...
                "A source file is large enough to make maintenance harder.",
                "Medium",
                "Maintainability",
                [
                    f"Largest file: {analysis.get('largest_file', 'unknown')}",
                    f"Lines: {largest}",
                ],
