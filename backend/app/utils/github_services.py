...
from app.utils.findings_generator import generate_findings
...
def _calculate_secret_exposure_score(
    ...
    # Penalize both sensitive filenames and content-level secret findings.
    finding_count = int(secret_exposure.get("secret_finding_count", 0) or 0)
...
def analyze_repository(repo):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        recommendation_analysis["findings"] = findings
        ai_recommendations = generate_ai_recommendations(recommendation_analysis)
    ...
    result = {
        ...
        "category_details": health_score.get("category_details", {}),
        "findings": findings,
